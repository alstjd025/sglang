...
# PD disaggregation defaults for a single node with 2 GPUs
export SGLANG_PD_PREFILL_PORT="${SGLANG_PD_PREFILL_PORT:-30000}"
export SGLANG_PD_DECODE_PORT="${SGLANG_PD_DECODE_PORT:-30001}"
export SGLANG_PD_ROUTER_PORT="${SGLANG_PD_ROUTER_PORT:-8000}"
